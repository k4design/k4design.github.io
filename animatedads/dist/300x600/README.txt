buymyhouse - 300x600 HTML5 ad (HD)
==================================

hd/         StackAdapt / DV360 - index.html + bg-300x600.mp4 + bg-300x600-still.jpg
            Half page. 320 px video band on top (300x250 HD asset cover-fit to 499x320, 90 px pan) fading into the panel;
...
backup-300x600-hd.jpg
            Static fallback (held final frame). Upload separately where asked - not in the zip.

buymyhouse_300x600_hd.zip   672 KB (video 550 KB)
            index.html at the ROOT of the zip, as platforms expect. To rebuild:
                cd hd && zip -r -X ../buymyhouse_300x600_hd.zip . -x '.DS_Store'

Specs met: <meta name="ad.size" content="width=300,height=600">, no external
