...
Internal library of the creative team's custom Figma plugins. The index is a
...
Live at `https://k4design.github.io/pluginlibrary/` (password below).
...
- **Structure** follows the Frame to MP4 guide — sticky nav with section
  ...
  FAQ accordions.
- **Colour** is the Real Estate Autofill palette — blue `#4d8dff` / violet
...
`assets/img/autofill-*.png` are the Real Estate Autofill plugin's real UI, not
